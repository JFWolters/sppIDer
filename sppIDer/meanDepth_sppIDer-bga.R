...
spcAvgFile <- paste(strainName, "_speciesAvgDepth-g.txt", sep="")
chrAvgFile <- paste(strainName, "_chrAvgDepth-g.txt", sep="")
outputFileName <- paste(strainName, "_winAvgDepth-g.txt", sep="")
