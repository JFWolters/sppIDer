...
bedData <- read.table(paste(outputPrefix, "_winAvgDepth-d.txt", sep=""), header=F, skip=2, col.names = c("Genome_Pos", "species", "chrom", "start",  "end", "meanValue", "log2mean", "max", "median"))
...
pdf(paste(outputPrefix, "_sppIDerDepthPlot-d.pdf", sep=""), width=14)
