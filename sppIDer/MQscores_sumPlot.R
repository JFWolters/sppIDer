...
chiSqOutName <- paste( strainName, "_MQ_chiSquared.txt", sep="")
summaryOutputName <- paste(strainName, "_MQsummary.txt", sep="")
plotOutputName <- paste(strainName, "_plotMQ.pdf", sep="")
