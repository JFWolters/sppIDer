...
spcAvgFile <- paste(strainName, "_speciesAvgDepth-d.txt", sep="")
chrAvgFile <- paste(strainName, "_chrAvgDepth-d.txt", sep="")
outputFileName <- paste(strainName, "_winAvgDepth-d.txt", sep="")
dataFileName <- paste(strainName, "-d.bedgraph", sep="")




#chrLens <- read.table(paste(workingDir, strainName, "_chrLens.txt", sep=""), header=F, col.names=c("chrom", "length"))
chrLens <- read.table(paste(strainName, "_chrLens.txt", sep=""), header=F, col.names=c("chrom", "length"))
